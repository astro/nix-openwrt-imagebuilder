# 24.10.0 ath79/generic
{
  baseUrl = "https://downloads.openwrt.org/releases/24.10.0/targets/ath79/generic/";
  sha256sums = {
    hash = "sha256-nVIkf7iks1irnQIt1Ih7f+GWsnBUAUOk8e5S24S2bwY=";
    name = "ath79_generic-sha256sums";
    url = "https://downloads.openwrt.org/releases/24.10.0/targets/ath79/generic/sha256sums";
  };
  imagebuilder = {
    sha256 = "376ac906a3b62e52574438798932be0cfd36d5236a472a397a0924e77b9910dd";
    filename = "openwrt-imagebuilder-24.10.0-ath79-generic.Linux-x86_64.tar.zst";
  };
  profiles.sourceInfo = {
    hash = "sha256-8PuvTiCXrm3zkhXp4kzEIcKmvZiK7ipQWVPiGLz42oY=";
    name = "ath79_generic-profiles.json";
    url = "https://downloads.openwrt.org/releases/24.10.0/targets/ath79/generic/profiles.json";
  };
  profiles.extract = {
    arch_packages = "mips_24kc";
    linux_kernel = {
      release = "1";
      vermagic = "c2bc166c1ba350209562f87ffdd33884";
      version = "6.6.73";
    };
    default_packages = [
      "base-files"
    ...
    kmods_target = "6.6.73-1-c2bc166c1ba350209562f87ffdd33884";
    profiles = {
      "8dev_carambola2" = {
  ...
  kmods."6.6.73-1-c2bc166c1ba350209562f87ffdd33884" = {
    baseUrl = "https://downloads.openwrt.org/releases/24.10.0/targets/ath79/generic/kmods/6.6.73-1-c2bc166c1ba350209562f87ffdd33884/";
    sourceInfo = {
      hash = "sha256-S8iQF10GbHKBCyiaaU7VAzX6czANlYc11gP+5WjUyME=";
      name = "kmods-ath79_generic-Packages";
      url = "https://downloads.openwrt.org/releases/24.10.0/targets/ath79/generic/kmods/6.6.73-1-c2bc166c1ba350209562f87ffdd33884/Packages";
    };
    packages =
      let
        p = ./kmods.nix;
  ...
  corePackages = {
    baseUrl = "https://downloads.openwrt.org/releases/24.10.0/targets/ath79/generic/packages/";
    sourceInfo = {
      hash = "sha256-N1WU0Ia7IhkbNfrJg6piAWLFGNQAzOhZsvBpov/hCoU=";
      name = "ath79_generic-Packages";
      url = "https://downloads.openwrt.org/releases/24.10.0/targets/ath79/generic/packages/Packages";
    };
    packages =
      let
        p = ./packages.nix;
