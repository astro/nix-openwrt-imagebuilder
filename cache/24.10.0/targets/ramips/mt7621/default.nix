# 24.10.0 ramips/mt7621
{
  baseUrl = "https://downloads.openwrt.org/releases/24.10.0/targets/ramips/mt7621/";
  sha256sums = {
    hash = "sha256-tmglpza3vkeA7cmqAPr5UIzB8NSlMax4sayQ+m9lNIo=";
    name = "ramips_mt7621-sha256sums";
    url = "https://downloads.openwrt.org/releases/24.10.0/targets/ramips/mt7621/sha256sums";
  };
  imagebuilder = {
    sha256 = "37b9bff3d501a79f63f146c6cecbd8223d48559a8b776e5ceb2672493f571b3e";
    filename = "openwrt-imagebuilder-24.10.0-ramips-mt7621.Linux-x86_64.tar.zst";
  };
  profiles.sourceInfo = {
    hash = "sha256-fNPUr3uOhNZxlvdanGJxhGgX+k1hY/nVSNNkAv84Qmw=";
    name = "ramips_mt7621-profiles.json";
    url = "https://downloads.openwrt.org/releases/24.10.0/targets/ramips/mt7621/profiles.json";
  };
  profiles.extract = {
    arch_packages = "mipsel_24kc";
    linux_kernel = {
      release = "1";
      vermagic = "3abe85def815b59c6c75ac1f92135cb6";
      version = "6.6.73";
    };
    default_packages = [
      "base-files"
    ...
    kmods_target = "6.6.73-1-3abe85def815b59c6c75ac1f92135cb6";
    profiles = {
      adslr_g7 = {
        device_packages = [
  ...
  kmods."6.6.73-1-3abe85def815b59c6c75ac1f92135cb6" = {
    baseUrl = "https://downloads.openwrt.org/releases/24.10.0/targets/ramips/mt7621/kmods/6.6.73-1-3abe85def815b59c6c75ac1f92135cb6/";
    sourceInfo = {
      hash = "sha256-nZRNRYmyeEILgT17n9O6wJ3NtdkhWYSRm3bjEVXVMSg=";
      name = "kmods-ramips_mt7621-Packages";
      url = "https://downloads.openwrt.org/releases/24.10.0/targets/ramips/mt7621/kmods/6.6.73-1-3abe85def815b59c6c75ac1f92135cb6/Packages";
    };
    packages =
      let
        p = ./kmods.nix;
  ...
  corePackages = {
    baseUrl = "https://downloads.openwrt.org/releases/24.10.0/targets/ramips/mt7621/packages/";
    sourceInfo = {
      hash = "sha256-eSRhWXCyFCJIY4Z8hQSpIrwcuQJOF0Sn0jAXey41vWc=";
      name = "ramips_mt7621-Packages";
      url = "https://downloads.openwrt.org/releases/24.10.0/targets/ramips/mt7621/packages/Packages";
    };
    packages =
      let
        p = ./packages.nix;
