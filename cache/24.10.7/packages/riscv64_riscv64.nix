...
{
  sha256sums = {
    hash = "sha256-LikUcofmdXDq/GzVXbBpv+Wb0dte88KmaPmAcT5mXm4=";
  ...
  feeds."packages" = {
    ...
    sourceInfo = {
      hash = "sha256-0d4KAOQ04crtZpzWVx+GrgSG468BPblJDXHMpAS79ZQ=";
  ...
  feeds."telephony" = {
    ...
    sourceInfo = {
      hash = "sha256-EhGiaNCDQ5B8Tip+OjMtB+zK1itAPVPD6YdbohjxapU=";
