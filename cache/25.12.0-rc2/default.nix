# Hashes for 25.12.0-rc2
{
  ...
  targets.malta.be64 = import ./targets/malta/be64/default.nix;
  targets.malta.le64 = import ./targets/malta/le64/default.nix;
  targets.malta.be = import ./targets/malta/be/default.nix;
  targets.malta.le = import ./targets/malta/le/default.nix;
