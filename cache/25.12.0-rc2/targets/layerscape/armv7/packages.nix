{
  ...
  base-files = {
    ...
    sha256 = "4373a59791634839f45104b7081778077aa3bb49a8c08a94d595ef2976fc1a5f";
  };
  block-mount = {
  ...
  kernel = {
    version = "6.12.63~37cf1ba2b2902c6a5ca78727a504288a-r1";
    filename = "kernel-6.12.63~37cf1ba2b2902c6a5ca78727a504288a-r1.apk";
    depends = [ "libc" ];
    sha256 = "f6059b6d32a762d3d8a9a813e579f6bd6596fce1424cfd9d240c8736394b8064";
  };
  layerscape-ppfe = {
    version = "6.12.20.2.0.0-r1";
    filename = "layerscape-ppfe-6.12.20.2.0.0-r1.apk";
    depends = [ "libc" ];
    sha256 = "01c48677df1c8e7f2559a3ccb3e0c4f34e5f591739cbb6d7cf1eb6c6233d6a21";
  };
  libatomic1 = {
    version = "14.3.0-r5";
  ...
  qosify = {
    ...
    sha256 = "8e55e2a45b8abff9312379f7620b886a563a3837b60a6b320c7d0c2a7a69d83e";
  };
  snapshot-tool = {
    version = "2025.10.03~12858e28-r1";
  ...
  uboot-envtools = {
    ...
    depends = [ "libc" ];
    sha256 = "67a735ab7415ddf67307b406e591e044cd4273ef9552b88b11e35022fa213652";
  };
  umbim = {
