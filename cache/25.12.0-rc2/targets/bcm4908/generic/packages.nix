{
  ...
  base-files = {
    ...
    sha256 = "f33c62c2229131ba9ce1904291d5bfa724372c03708bcb089d1f8af269c7e4c4";
  };
  bcm4908img = {
    version = "3";
    filename = "bcm4908img-3.apk";
    depends = [ "libc" ];
    sha256 = "85981a1f4a38f4e2ee7862224c67802d0154051275e7207f5fa614612c8a4172";
  };
  bcm63xx-cfe = {
    version = "2025.04.02~b8128fa4-r1";
    filename = "bcm63xx-cfe-2025.04.02~b8128fa4-r1.apk";
    depends = [ "libc" ];
    sha256 = "b806ab5e45e7f515993646f885dac8790c469e01798425c7adebbc2c042d4f00";
  };
  block-mount = {
  ...
  kernel = {
    version = "6.12.63~17a06b4ce71cd1d237d28423c8d6ac37-r1";
    filename = "kernel-6.12.63~17a06b4ce71cd1d237d28423c8d6ac37-r1.apk";
    depends = [ "libc" ];
    sha256 = "cfe2bfbefd589a757594d51494e38289710854e42bdc3eab889cfdb99213078a";
  };
  libatomic1 = {
    version = "14.3.0-r5";
  ...
  qosify = {
    ...
    sha256 = "1d73115219a3c64128ccc4e8494837771b8e01a9c5d9d935517a219cff5db56a";
  };
  snapshot-tool = {
    version = "2025.10.03~12858e28-r1";
