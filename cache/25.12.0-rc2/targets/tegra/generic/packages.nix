{
  ...
  base-files = {
    ...
    sha256 = "2954cb6bca5c61c4a198a2875033071817ccbec3f06d7c3971256df1f04e874a";
  };
  block-mount = {
    ...
    sha256 = "b538653d4032f915a44010da392f73e708cfd30888c0b2135bf98aae6cb5d6e0";
  };
  blockd = {
    version = "2025.10.03~12858e28-r1";
  ...
  fstools = {
    ...
    sha256 = "fc6a2e10838ae42802aa19ef9bd412b91a26b4a397260f73e3c671651d182e88";
  };
  fwtool = {
  ...
  kernel = {
    version = "6.12.63~033652b74e3cf7362ca81bcc6eb69e8e-r1";
    filename = "kernel-6.12.63~033652b74e3cf7362ca81bcc6eb69e8e-r1.apk";
    depends = [ "libc" ];
    sha256 = "04e1fac6d2491693d27a36900ad616a2e2004164ae5083f6989c6d880447e515";
  };
  libatomic1 = {
    version = "14.3.0-r5";
  ...
  mtd = {
    ...
    sha256 = "93400728b2eb7360ad9b4f19d4ebee991787dae1575892eeade3df34183b802d";
  };
  qosify = {
    ...
    sha256 = "9a0201265718e240f6813205e450a416fd8d5c97d5acbef839a64e9b1a1978a2";
  };
  snapshot-tool = {
    version = "2025.10.03~12858e28-r1";
  ...
  uboot-envtools = {
    ...
    depends = [ "libc" ];
    sha256 = "9ea88bd7c4f26df32fb95bea432ce9820577c73a9e92256f4e90bcd060ec1c4a";
  };
  umbim = {
