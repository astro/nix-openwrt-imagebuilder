# 25.12.4 mediatek/filogic
{
  baseUrl = "https://downloads.openwrt.org/releases/25.12.4/targets/mediatek/filogic/";
  sha256sums = {
    hash = "sha256-M+TVrec7VI7FDHCxaZkKRXP0hLT+IxwDPXxLBU83DPU=";
    name = "mediatek_filogic-sha256sums";
    url = "https://downloads.openwrt.org/releases/25.12.4/targets/mediatek/filogic/sha256sums";
  };
  imagebuilder = {
    sha256 = "8207da9d689f02d42833e4e8abc9eabb4ec63a433a7a26473296d3d2c489e257";
    filename = "openwrt-imagebuilder-25.12.4-mediatek-filogic.Linux-x86_64.tar.zst";
  };
  profiles.sourceInfo = {
    hash = "sha256-lWtfaIQNe6CCCVHDdkxmKx3dJqMAZjGebFiVOBjM25g=";
    name = "mediatek_filogic-profiles.json";
    url = "https://downloads.openwrt.org/releases/25.12.4/targets/mediatek/filogic/profiles.json";
  };
  profiles.extract = {
    arch_packages = "aarch64_cortex-a53";
    linux_kernel = {
      release = "1";
      vermagic = "82967b4996cac5f682958cca092c9ab1";
      version = "6.12.87";
    };
    default_packages = [
      "apk-mbedtls"
    ...
    kmods_target = "6.12.87-1-82967b4996cac5f682958cca092c9ab1";
    profiles = {
      abt_asr3000 = {
        device_packages = [
          "kmod-mt7915e"
  ...
  kmods."6.12.87-1-82967b4996cac5f682958cca092c9ab1" = {
    baseUrl = "https://downloads.openwrt.org/releases/25.12.4/targets/mediatek/filogic/kmods/6.12.87-1-82967b4996cac5f682958cca092c9ab1/";
    sourceInfo = {
      hash = "sha256-Jv5UjZgz/2jXeLmnWrVLdyKGvHaCj+dqaDw+1cMs0e4=";
      name = "kmods-mediatek_filogic-packages.adb";
      url = "https://downloads.openwrt.org/releases/25.12.4/targets/mediatek/filogic/kmods/6.12.87-1-82967b4996cac5f682958cca092c9ab1/packages.adb";
    };
    packages =
      let
        p = ./kmods.nix;
  ...
  corePackages = {
    baseUrl = "https://downloads.openwrt.org/releases/25.12.4/targets/mediatek/filogic/packages/";
    sourceInfo = {
      hash = "sha256-ZeT4r0gXjskpjLpeArGzsWDVbhZbQWZ629SeA8p/3zY=";
      name = "mediatek_filogic-packages.adb";
      url = "https://downloads.openwrt.org/releases/25.12.4/targets/mediatek/filogic/packages/packages.adb";
    };
    packages =
      let
        p = ./packages.nix;
