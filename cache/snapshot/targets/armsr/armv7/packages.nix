{
  ...
  base-files = {
    ...
    sha256 = "35b1235776fbf5f7a49de75bf6b86563a09639f454a02e2f470d3aa348bc05f6";
  };
  block-mount = {
  ...
  grub2-efi-arm = {
    ...
    sha256 = "a32cc7c09f53c5524688f3d6edc3b6683e27a12a1ac08d50e2679089cc26a260";
  };
  ip6tables-extra = {
    version = "1.8.10-r2";
  ...
  kernel = {
    version = "6.12.74~7db22d95631b702e4f875dd95cb35a4b-r1";
    filename = "kernel-6.12.74~7db22d95631b702e4f875dd95cb35a4b-r1.apk";
    depends = [ "libc" ];
    provides = [ "kernel-any" ];
    sha256 = "d33070aa41e0d4a5877a8c565fc569aaf3de7dcb4ba25dcdd14df06df15f045f";
  };
  libatomic1 = {
    version = "14.3.0-r5";
  ...
  uboot-envtools = {
    ...
    sha256 = "f5acb91a652a0cf44b4d3fdc6a4054e6d0ee3ef45331eacc9d52072e36a28a95";
  };
  umbim = {
