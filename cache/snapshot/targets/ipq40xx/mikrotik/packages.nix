{
  ...
  base-files = {
    ...
    sha256 = "2fe8edb9f85caa51db4d69c91cff56c0c11ddac99850f172619984a760ad06a6";
  };
  block-mount = {
  ...
  jool-tools-netfilter = {
    ...
    sha256 = "453217ae8fe73b3a3f70c6148cb2acdd264ba23d4a7dcab311b9f4ea1619330f";
  };
  kernel = {
    version = "6.12.74~b31d27790477fd101c935237c44dc477-r1";
    filename = "kernel-6.12.74~b31d27790477fd101c935237c44dc477-r1.apk";
    depends = [ "libc" ];
    provides = [ "kernel-any" ];
    sha256 = "844e0cdaa7b1bcc646a0871be17eaa980bf9edfc6574c724a3feaebe5d58d6ac";
  };
  libatomic1 = {
    version = "14.3.0-r5";
