{
  ...
  base-files = {
    ...
    sha256 = "1e700b29bf1f386345de5bf9266781963a2d33961a823af1a4d8b79146ffcca3";
  };
  block-mount = {
    ...
    sha256 = "dd2db09be5ddef9dad9ef0361b9a2ad652724dd75862da0bb91411bd9b463dc0";
  };
  blockd = {
    version = "2026.02.15~8d377aa6-r1";
  ...
  fstools = {
    ...
    sha256 = "dc6a50cd9b74db0ad794aa9a8d45c3e93224db28f2013e300b43534686bc6c59";
  };
  fwtool = {
  ...
  kernel = {
    version = "6.12.74~4266e00181e8c795291653a4a0b65045-r1";
    filename = "kernel-6.12.74~4266e00181e8c795291653a4a0b65045-r1.apk";
    depends = [ "libc" ];
    provides = [ "kernel-any" ];
    sha256 = "0aea26df6031aa096c6c03047ff80e31b5ecedff40d39eeedb4bfd15f4889845";
  };
  libatomic1 = {
    version = "14.3.0-r5";
  ...
  uboot-envtools = {
    ...
    sha256 = "44abe0cda76667993464e7b2ff2b03d786920d5e00e25e3a12e19aa651c054d3";
  };
  umbim = {
