{
  ...
  base-files = {
    ...
    sha256 = "6d1af7d47fb1732aeba3685d137c266afa3f9cd3181bc209213f8c6a5dc315a1";
  };
  block-mount = {
  ...
  kernel = {
    version = "6.12.74~0a8bb43f00d6a023004ecc2de3382969-r1";
    filename = "kernel-6.12.74~0a8bb43f00d6a023004ecc2de3382969-r1.apk";
    depends = [ "libc" ];
    provides = [ "kernel-any" ];
    sha256 = "ffaa63bcdea5d948363d2b21b8bbdddc5dd67798d547326adea5f3c3dcfb8ff9";
  };
  libatomic1 = {
    version = "14.3.0-r5";
  ...
  uboot-envtools = {
    ...
    sha256 = "f38ffd082ad50e4a0186e2e2d58eff0c6afe51ce5c778c2c087136302a19219f";
  };
  xtables-legacy = {
    version = "1.8.10-r2";
