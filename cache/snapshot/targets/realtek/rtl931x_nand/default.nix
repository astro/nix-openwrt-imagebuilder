# snapshot realtek/rtl931x_nand
{
  ...
  kmods."6.18.44-1-1fb1d1de482feddedfdf2f3291999775" = {
    ...
    sourceInfo = {
      hash = "sha256-YPtjIgTkSkAIqExrZ5bEkRprGoucs3MEN+qCoOCDvzc=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-v8onrAiAUeJpg41ULofMbK+EO8IgHzn45al+7nrmD9Y=";
