# snapshot realtek/rtl931x_nand
{
  ...
  kmods."6.18.41-1-1fb1d1de482feddedfdf2f3291999775" = {
    ...
    sourceInfo = {
      hash = "sha256-rUPz2heK+Dc7x+5JD0rnUHigjzso0LbPYJ9zAiGOh50=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-hkJpRc2k4CmhNpjuh1PqBIJpXTanmtwWF5FAZ0MVL9M=";
