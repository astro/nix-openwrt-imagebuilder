# snapshot realtek/rtl931x_nand
{
  ...
  kmods."6.18.35-1-3957a8a47ca0c47e89f19337a89a10c4" = {
    ...
    sourceInfo = {
      hash = "sha256-RxtRCCvPPIhJjGlLyhwL48EC+r0Mn7S8opBpz+sYfcw=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-xx5w9TIEVFXYQqCrhS+Gtk50dgQheGuBCP5XhIx0y6M=";
