# snapshot realtek/rtl931x_nand
{
  ...
  kmods."6.12.74-1-f1ab893abb166601beb20ded55806746" = {
    ...
    sourceInfo = {
      hash = "sha256-uWUVAms4omwiYZtBtiMtZa+STJAIX6oSkdZavopkTE0=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-eHmoMsY4eO/hxd0eN2ahDYWhcKf8RhmQexpPVNYJUF0=";
