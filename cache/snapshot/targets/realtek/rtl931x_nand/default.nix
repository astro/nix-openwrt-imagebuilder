# snapshot realtek/rtl931x_nand
{
  ...
  kmods."6.18.39-1-1fb1d1de482feddedfdf2f3291999775" = {
    ...
    sourceInfo = {
      hash = "sha256-G0ZzZONHGW5eVls/sniCvOk3hQ/UziQmb/xJRXOD6uM=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-qSiyyo7isTKP1RpkaD0D8XVDfgqDIB/oaP9N+K15wPM=";
