# snapshot realtek/rtl931x_nand
{
  ...
  kmods."6.18.44-1-1fb1d1de482feddedfdf2f3291999775" = {
    ...
    sourceInfo = {
      hash = "sha256-awh+MYHUnvy9kiUGeYxjrjQfXKTnMMo/qPQ/lJ5Tg/k=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-LkABYIJRFMdLpEOphunOYD5UMVv0XMw3swnwh2peQMI=";
