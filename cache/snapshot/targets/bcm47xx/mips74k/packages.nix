{
  ...
  base-files = {
    ...
    sha256 = "5f807a94d2189fa3b11506c0b25355fa139a0e3202a679b643b3502a93122bf8";
  };
  block-mount = {
  ...
  dropbear = {
    ...
    sha256 = "54e71d82c78df0663e524018dfdd3ab2f7bbdf13f57d32c5ba196aa52f83be06";
  };
  dropbearconvert = {
    version = "2025.89-r1";
    ...
    sha256 = "b9c0631d0eab21f148363b6e10f4b0479a445697573f90e8e40a7b7915443087";
  };
  ebtables-nft = {
    version = "1.8.10-r2";
  ...
  kernel = {
    version = "6.12.74~d6b1a2bbc1656459b327ed870d542f88-r1";
    filename = "kernel-6.12.74~d6b1a2bbc1656459b327ed870d542f88-r1.apk";
    depends = [ "libc" ];
    provides = [ "kernel-any" ];
    sha256 = "2735e818ef227c47828a092d6d0a367757ee9e72cf633aca3d250f0bfc2acb9e";
  };
  libatomic1 = {
    version = "14.3.0-r5";
  ...
  nvram = {
    ...
    depends = [ "libc" ];
    provides = [ "nvram-any" ];
    sha256 = "a8615e203273aa8c2c4b7d0394a6fd77f0f4a9b5d7b4b215df089b91a34c5b99";
  };
  otrx = {
  ...
  uboot-envtools = {
    ...
    sha256 = "095b3e5f7f550c084cd31ac9ed09c90639b36ecba788241817a9d08a03b2d3b6";
  };
  umbim = {
