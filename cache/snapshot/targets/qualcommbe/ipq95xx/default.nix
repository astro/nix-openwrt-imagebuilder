# snapshot qualcommbe/ipq95xx
{
  ...
  kmods."6.18.52-1-d1504ac5bf0d29b8ff08a15e8dc460e9" = {
    ...
    sourceInfo = {
      hash = "sha256-x2rsLPFao07VOnitn7WY4AIDox4xMHPTzEHP93B37Pg=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-hmpfsVX6BWhcAO1PTN4l3vnXuUGBe/7GYueA3nMR1Iw=";
