# snapshot qualcommbe/ipq95xx
{
  ...
  kmods."6.18.52-1-34cd8d0cb0baaaf1de626e4bf564b5b6" = {
    ...
    sourceInfo = {
      hash = "sha256-3zOaxp+8d1g+htOYEJ4/gDDKW9QSpUyg+AuF9HXygaA=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-85pmaTB3LaCUn/CM2WUlQsmyerA1xUJb+Bh3DZasv+s=";
