# snapshot qualcommbe/ipq95xx
{
  ...
  kmods."6.18.44-1-d1504ac5bf0d29b8ff08a15e8dc460e9" = {
    ...
    sourceInfo = {
      hash = "sha256-SIoj1bvIeZm/ujNVanikC+3KSfoax0Mh4aeU094wPcU=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-OCligORDU0HolUBtb2GsXZ5aQ4Vn4f5qD+UyEWwgyzc=";
