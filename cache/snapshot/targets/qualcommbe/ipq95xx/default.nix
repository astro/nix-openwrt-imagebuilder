# snapshot qualcommbe/ipq95xx
{
  ...
  kmods."6.18.52-1-34cd8d0cb0baaaf1de626e4bf564b5b6" = {
    ...
    sourceInfo = {
      hash = "sha256-GDzPqdJP3+XFE5xigv1wsl24vcM6N4/LAGF96BC7eyc=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-1IPMwK1x6rmJiEQnmkLbSbnZEoY8Q57gRAFOdP7lIGw=";
