# snapshot qualcommbe/ipq95xx
{
  ...
  kmods."6.18.44-1-77a5f91d40d309e87b5c72fff6d5542a" = {
    ...
    sourceInfo = {
      hash = "sha256-6sbLlRPHe/BoLKmDc8vlyAkk4TleCH/ZiEqNuyPoAKE=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-ZM6eMMRXQSu7nmDSZCnqz5PEJ9SrrUan+aKOefDaTEM=";
