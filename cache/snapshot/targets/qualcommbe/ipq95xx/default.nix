# snapshot qualcommbe/ipq95xx
{
  ...
  kmods."6.18.52-1-34cd8d0cb0baaaf1de626e4bf564b5b6" = {
    ...
    sourceInfo = {
      hash = "sha256-N2wYqAS2/I0HGrK7UEtyBjBk+mJjiBPlLZOili7J5rg=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-xuGRIEP1lRzmDqdaarkljvuTOjeuWDMdvetrL2nObqc=";
