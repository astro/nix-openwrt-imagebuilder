# snapshot layerscape/armv7
{
  ...
  sha256sums = {
    hash = "sha256-I8qHE6g2tkeorBT6AXL1O7jYx35uo+7ro+OgFfIitQA=";
    name = "layerscape_armv7-sha256sums";
    url = "https://downloads.openwrt.org/snapshots/targets/layerscape/armv7/sha256sums";
  };
  imagebuilder = {
    sha256 = "f213f58faf60f27efe065c00e16b310a05ff8c24d4bc492c1fb23c4a211812d1";
    filename = "openwrt-imagebuilder-layerscape-armv7.Linux-x86_64.tar.zst";
  };
  profiles.sourceInfo = {
    hash = "sha256-oe4L+OCmOoYdbmdoSqSH9J2AEofYWRALnaQXKSbvZYU=";
  ...
  kmods."6.12.93-1-89bf0077560f07f2ab7ba5e3175dc1fe" = {
    ...
    sourceInfo = {
      hash = "sha256-Jsyd1PVKI462ncPbVleB7UQY3qBt2YNPmDKaA6dNhVw=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-i2S4Esl3d89W1XrGQH4nNS5TGpoejVfDG3DTQSvWlNg=";
