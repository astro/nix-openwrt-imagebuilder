# snapshot qualcommax/ipq50xx
{
  ...
  kmods."6.12.84-1-b98d4df02d91246d02bb3849ff1078d1" = {
    ...
    sourceInfo = {
      hash = "sha256-U4Fo9chustR6KAeqWexcJUgvmA+OBt2WHUJ4VNS7UMI=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-Tw67RprYG1929R0pPR2VqObRRJCnwOS+a5v41dEmid4=";
