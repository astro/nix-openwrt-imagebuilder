# snapshot qualcommax/ipq50xx
{
  ...
  kmods."6.12.89-1-11a6822086f20b0edc14bf2f06be25bf" = {
    ...
    sourceInfo = {
      hash = "sha256-i6S4LMSwek0ok9UXz+tyRLpHIvB1guec3w1XQxI+pyU=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-5AbsbEt73zN9HGkGhlhIH8qygt/X5HYnDLlL2WS3EsI=";
