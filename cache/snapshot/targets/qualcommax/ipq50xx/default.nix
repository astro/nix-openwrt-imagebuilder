# snapshot qualcommax/ipq50xx
{
  ...
  kmods."6.12.77-1-14a0db9144d6c95f633fb086074bf66b" = {
    ...
    sourceInfo = {
      hash = "sha256-8UYi+WxN7xswfLvlBGGKdReVCQytxtjTB2sDE2UXws4=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-5DLWEZPIzNkyPCTNdROUZq1qimG5MOnyWCZWeSz8qAk=";
