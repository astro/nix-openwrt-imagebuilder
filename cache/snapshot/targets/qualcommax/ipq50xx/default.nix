# snapshot qualcommax/ipq50xx
{
  ...
  kmods."6.12.74-1-14a0db9144d6c95f633fb086074bf66b" = {
    ...
    sourceInfo = {
      hash = "sha256-XNBng1+xWrKBc2NJIpBeim0UomUlsLMU9oKuky2jbbc=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-D95BVnuhde2DGWrk3sN/rNnsm0+lCWELgS4ciE1NrCI=";
