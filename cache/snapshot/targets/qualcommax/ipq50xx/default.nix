# snapshot qualcommax/ipq50xx
{
  ...
  kmods."6.12.94-1-decd6bcf8e30eb499d3e541c414d0993" = {
    ...
    sourceInfo = {
      hash = "sha256-4DBaGs0gaisShdHDgcdudDPT7sgCq74EP2IGYdcgEJk=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-s/GVJ00LTVqSOtK3v9IRxdRTgnqd4ZBnyxmutXVpsos=";
