# snapshot qualcommax/ipq50xx
{
  ...
  kmods."6.18.44-1-08969e59efe868e25e4226e8ab9bdc98" = {
    ...
    sourceInfo = {
      hash = "sha256-+yFtq5PXhxQA66dBkoa98LDXU3ZLzijfeYtXwzpHIpI=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-we8rYs85ob/S0g9A+KRMsGYceDJoP7k+Pdz+G4eXnTM=";
