# snapshot qualcommax/ipq50xx
{
  ...
  kmods."6.12.80-1-372044a6b609acf5a388ab87f1f97b51" = {
    ...
    sourceInfo = {
      hash = "sha256-lv6O9p+Kv78p9cV+p/Dor00uNlikSQfrNz5raX9uQuw=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-NQ9cpVUXk63DxC8DPtacnA1b4IP2k7XylMe75lTrTwM=";
