# snapshot qualcommax/ipq50xx
{
  ...
  kmods."6.12.74-1-14a0db9144d6c95f633fb086074bf66b" = {
    ...
    sourceInfo = {
      hash = "sha256-4ug6Tr5O8IPdwXCEvj3mPTI0oXNcNjKm6+diUdNC1+M=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-lrPlInQaJi/SlOKG7FAFJbew7WJiWDgeSsJEV+MuVUA=";
