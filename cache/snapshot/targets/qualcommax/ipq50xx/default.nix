# snapshot qualcommax/ipq50xx
{
  ...
  kmods."6.18.41-1-70ee6f9122e9eb839e386a6e333859ce" = {
    ...
    sourceInfo = {
      hash = "sha256-nMY4uPBh193V05cK3dPZXXRuDmYOt7EPZQoqXsJNj+g=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-Go2yRsSAw7qLcodhenvnr8AHAo6fQQa7B+bLevRGGpI=";
