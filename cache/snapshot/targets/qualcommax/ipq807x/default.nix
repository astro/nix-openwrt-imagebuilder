# snapshot qualcommax/ipq807x
{
  ...
  kmods."6.12.94-1-044d20c1bfa6819b93aaf46fd32f24cd" = {
    ...
    sourceInfo = {
      hash = "sha256-gMfV7+80KYtzM3dSYMXehuqJeDjEAfyPD7ndIVzMF0g=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-lIeqwluG7em2vu+TchYxdM6aJuuMzilJCpCVFZwW3b0=";
