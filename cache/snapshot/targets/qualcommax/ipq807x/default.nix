# snapshot qualcommax/ipq807x
{
  ...
  kmods."6.12.94-1-044d20c1bfa6819b93aaf46fd32f24cd" = {
    ...
    sourceInfo = {
      hash = "sha256-9aQFzZVRt0bZIQdu2+L9TS+AIiGuCzeeVE0XXkHvbhQ=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-gV5bvJDORdLtfQK+QHjQcb7Uz/gjyl98/wdT3G3QmYc=";
