# snapshot qualcommax/ipq807x
{
  ...
  kmods."6.18.44-1-d59fb96a0bdb8b70ff0b23af68de8ff1" = {
    ...
    sourceInfo = {
      hash = "sha256-DiTvl9UvBpZrcXEVLOqNUAlX0E1ToR+mmZLxeXhBLHE=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-ZdrloQHjXY0uZgckrDPMmsNSTn12ldQ1iCHvBCugpHU=";
