# snapshot qualcommax/ipq807x
{
  ...
  kmods."6.12.94-1-fb2f623fb3544377714d7392606a930a" = {
    ...
    sourceInfo = {
      hash = "sha256-uxgeGAuLKoQk5YqtOElscrNXCHbY7pcVOau5tx1R46I=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-SdZuhVlHFLNmHzoo+bgevoYsqH/1HYWWiPbOvHYMjXU=";
