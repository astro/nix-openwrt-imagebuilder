# snapshot qualcommax/ipq807x
{
  ...
  kmods."6.12.80-1-044bf655d806999739e8539fcbad05cd" = {
    ...
    sourceInfo = {
      hash = "sha256-C5mbfUUu1FXWBNIGvW+gnMFLxTgtIRBqjJP08+sFI1I=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-/M8iybqcDZ8m90NmOQfg2fX+hTy8GOZF4xrRMjaMWU0=";
