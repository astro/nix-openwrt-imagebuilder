# snapshot qualcommax/ipq807x
{
  ...
  kmods."6.12.87-1-cd4ff43bed9fb10028060d69f94884c9" = {
    ...
    sourceInfo = {
      hash = "sha256-Ld+VU+uuDCTbRXffwKacee/rt2g90Jteg0FT9uV9j+A=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-amBMmOhimEqttc0s0rMx8LOBp0kuOs+IoUtLy8LS5sw=";
