# snapshot qualcommax/ipq807x
{
  ...
  kmods."6.12.94-1-fb2f623fb3544377714d7392606a930a" = {
    ...
    sourceInfo = {
      hash = "sha256-jhT4tc9iKGsjyGehElb2Y+i8vX6Kh+cQHHpFwpasSX8=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-ehZKclsoSk8NtX3afosJ/m/mq+b7C2s4vA3xHZ5RxHs=";
