# snapshot qualcommax/ipq807x
{
  ...
  kmods."6.12.80-1-044bf655d806999739e8539fcbad05cd" = {
    ...
    sourceInfo = {
      hash = "sha256-hhGKcYHsYy6D7MCgIDi2sNa+a4rvH1un0DvcfCbEs38=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-iO5C64HVEMSsKzdpIu6nHJkyeW/BDRRzqXwJCl67YwU=";
