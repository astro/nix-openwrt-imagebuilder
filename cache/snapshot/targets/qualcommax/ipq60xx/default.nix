# snapshot qualcommax/ipq60xx
{
  ...
  kmods."6.12.94-1-a956bb404f7396606e2ae897b571a230" = {
    ...
    sourceInfo = {
      hash = "sha256-IZJrl4NDAJjMs4aIBdFVpZfyBWJVpMXxsfzd3dSP9Ns=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-66xHChW/h52cMdVeg6exN8VNaDlhLSjGTPu+t6egoSg=";
