# snapshot qualcommax/ipq60xx
{
  ...
  kmods."6.18.44-1-215d75db9652f3e02c8ebd3cb302b452" = {
    ...
    sourceInfo = {
      hash = "sha256-bowbRvvoJ8fbENBMiDWSA29allVH/gMuV/dD6g3dsG0=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-CRunMsnzwP7SDhvw3uGcIIRJmX94QAjTV8WAfla2pk4=";
