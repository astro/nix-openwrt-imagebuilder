# snapshot qualcommax/ipq60xx
{
  ...
  kmods."6.12.94-1-931fc39d9225d69256970cc1532dd431" = {
    ...
    sourceInfo = {
      hash = "sha256-H+Mcq0pL8deREeaSeGMszJ33oVQNtrGLd2LPap8oi9c=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-rx+Dkv2pWlHcErH1jd5zkiIlhaGpc5/5shCiaU+8I14=";
