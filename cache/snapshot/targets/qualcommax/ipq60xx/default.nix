# snapshot qualcommax/ipq60xx
{
  ...
  kmods."6.18.44-1-8c1a1b01e9bd5f8925a50037a12e1b25" = {
    ...
    sourceInfo = {
      hash = "sha256-nhrcl26kcUea1NNmUFGJ5JfbX+BzBg4n+idHDztuAus=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-Pl3XhRz+G1NAzDGORoT25HnkDh2BaFApWKIc+tOgSD4=";
