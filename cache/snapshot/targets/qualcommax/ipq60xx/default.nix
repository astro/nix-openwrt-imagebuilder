# snapshot qualcommax/ipq60xx
{
  ...
  kmods."6.12.94-1-a956bb404f7396606e2ae897b571a230" = {
    ...
    sourceInfo = {
      hash = "sha256-6y7fLo+GiWZ1BcCcvosSqGmOMANO7b/t5STfs+maTbU=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-lUuLCrTDLXPaOabO1WX9IPFCSK06tuXRS7OolNPo094=";
