# snapshot qualcommax/ipq60xx
{
  ...
  kmods."6.12.80-1-9cfabe0504597f70c60bba6a0cfdc963" = {
    ...
    sourceInfo = {
      hash = "sha256-AdB6ePVFhd84ugPhwhWmo9gqsOzcdjotuLtbxJLPbOs=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-088ISmeziv6Kk3EDVK2UpwOdVjuaVzp07U3hIjW4CZY=";
