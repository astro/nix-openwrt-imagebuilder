# snapshot microchipsw/lan969x
{
  ...
  kmods."6.18.44-1-e98851781bb1c707a750721fc1b67274" = {
    ...
    sourceInfo = {
      hash = "sha256-KwCYOV0KndwrgkmcMn0Fcj6rusyPCeVeazHkODVMErQ=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-O/mpWXRqsywhrsY75s8TSi8pmIxqbt5qDCxMHBarek4=";
