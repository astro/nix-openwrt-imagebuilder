# snapshot microchipsw/lan969x
{
  ...
  kmods."6.12.74-1-9c51291b222857dfa452732e3c4f4ab5" = {
    ...
    sourceInfo = {
      hash = "sha256-+SHUi1b1wuocwk7h2d7Hf6SNTgzIpV1Ed+ttz9cXCDE=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-wnayX5A6QjDMxiOeTJ+rDWYVR/K/LLQZBYjiHoBZyLM=";
