# snapshot microchipsw/lan969x
{
  ...
  kmods."6.18.38-1-be87b6af0e277bf308a5cfe8eb9c4d0a" = {
    ...
    sourceInfo = {
      hash = "sha256-zItQzOdhK8c3kKx+uKSDjWynroK3gWAGOA3H9HSQaeY=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-eoFeSKb9jpJdpT0NVMQjJA1iZOJ9LWPsY/1P2p4z040=";
