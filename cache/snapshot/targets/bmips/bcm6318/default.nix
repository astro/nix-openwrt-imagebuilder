# snapshot bmips/bcm6318
{
  ...
  sha256sums = {
    hash = "sha256-3GSadRgqv8zppfp9OXlzSHVTAxMobDgMP341kKY7Tlc=";
    name = "bmips_bcm6318-sha256sums";
    url = "https://downloads.openwrt.org/snapshots/targets/bmips/bcm6318/sha256sums";
  };
  imagebuilder = {
    sha256 = "f4e6cb0633fc2ea28d73f3997426d8ddc0cf712fd7fddb2501f71c1b81b182a8";
    filename = "openwrt-imagebuilder-bmips-bcm6318.Linux-x86_64.tar.zst";
  };
  profiles.sourceInfo = {
    hash = "sha256-jSR5D9vXPJJDbe9ZIjIP+IU4v1plZ1PNHd9Tr21eOXY=";
  ...
  kmods."6.12.100-1-094f275468c1cd15a4e6fd6924077d83" = {
    ...
    sourceInfo = {
      hash = "sha256-XXzRa1EQXhIkmQ51UFOBp+g8pDRtyrXU+aB8ajXRxGk=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-MqnK6InSFseQHsHyJvRc5DBEZLfp7DznUTVAOWSzqdY=";
