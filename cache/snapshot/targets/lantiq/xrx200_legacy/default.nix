# snapshot lantiq/xrx200_legacy
{
  ...
  kmods."6.12.89-1-476a4fffb9cb9ada8d302c5e759fc4ca" = {
    ...
    sourceInfo = {
      hash = "sha256-WUQYsralmNveGt2br+VPnm2s7icl0hne1XrUDyDiuKw=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-8jpkgJYctOD/8mhWRGTrxK/9rBuMiUXNqI3BxwCCpb0=";
