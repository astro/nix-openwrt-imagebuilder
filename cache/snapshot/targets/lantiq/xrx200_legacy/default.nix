# snapshot lantiq/xrx200_legacy
{
  ...
  kmods."6.12.94-1-daa6f02ad172de7ac30e746ea13858fd" = {
    ...
    sourceInfo = {
      hash = "sha256-hz2dFweEJm7URzbWTaH7mWmnUvU2TRijDsyAHdGaUM8=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-N8ghsJJeLD+RNp+fWW95cEGcBs4sRNuakbianv21VR4=";
