# snapshot lantiq/xrx200_legacy
{
  ...
  kmods."6.12.94-1-daa6f02ad172de7ac30e746ea13858fd" = {
    ...
    sourceInfo = {
      hash = "sha256-Sg6/RP7RS9Ba7SaEwGt7ndVRIcAJ+ay3Ti/hliDLYpM=";
  ...
  corePackages = {
    ...
    sourceInfo = {
      hash = "sha256-IVHOKy+rToUo76fZMKotRZUBeSibKF6NcgayRwV4ZNg=";
