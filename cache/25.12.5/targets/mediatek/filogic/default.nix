# 25.12.5 mediatek/filogic
{
  baseUrl = "https://downloads.openwrt.org/releases/25.12.5/targets/mediatek/filogic/";
  sha256sums = {
    hash = "sha256-4bWc2Ld9TPtPeEshFAp4JeGUrkDI2S2LUwzqzA0Co44=";
    name = "mediatek_filogic-sha256sums";
    url = "https://downloads.openwrt.org/releases/25.12.5/targets/mediatek/filogic/sha256sums";
  };
  imagebuilder = {
    sha256 = "7fb6cf626582ebcbfb46974da48c1eae577213f38879eaf6b1d982041e843461";
    filename = "openwrt-imagebuilder-25.12.5-mediatek-filogic.Linux-x86_64.tar.zst";
  };
  profiles.sourceInfo = {
    hash = "sha256-ocRIxY6KHMoBauDODQ0C5fU7l+O2eo2eLuSu405gLdI=";
    name = "mediatek_filogic-profiles.json";
    url = "https://downloads.openwrt.org/releases/25.12.5/targets/mediatek/filogic/profiles.json";
  };
  profiles.extract = {
    arch_packages = "aarch64_cortex-a53";
    linux_kernel = {
      release = "1";
      vermagic = "5a6c1f71be683ae9980b15d3ce73e24d";
      version = "6.12.94";
    };
    default_packages = [
      "apk-mbedtls"
    ...
    kmods_target = "6.12.94-1-5a6c1f71be683ae9980b15d3ce73e24d";
    profiles = {
      abt_asr3000 = {
        device_packages = [
          "kmod-mt7915e"
  ...
  kmods."6.12.94-1-5a6c1f71be683ae9980b15d3ce73e24d" = {
    baseUrl = "https://downloads.openwrt.org/releases/25.12.5/targets/mediatek/filogic/kmods/6.12.94-1-5a6c1f71be683ae9980b15d3ce73e24d/";
    sourceInfo = {
      hash = "sha256-2bHRRZHPD8Wwpp6hthjzMSyW5KyH0BP+Hnaqw0hnAi0=";
      name = "kmods-mediatek_filogic-packages.adb";
      url = "https://downloads.openwrt.org/releases/25.12.5/targets/mediatek/filogic/kmods/6.12.94-1-5a6c1f71be683ae9980b15d3ce73e24d/packages.adb";
    };
    packages =
      let
        p = ./kmods.nix;
  ...
  corePackages = {
    baseUrl = "https://downloads.openwrt.org/releases/25.12.5/targets/mediatek/filogic/packages/";
    sourceInfo = {
      hash = "sha256-kqIVVpSUCBd2SeADDzA8vCdx2YOGz+HV4RpsIA68H3I=";
      name = "mediatek_filogic-packages.adb";
      url = "https://downloads.openwrt.org/releases/25.12.5/targets/mediatek/filogic/packages/packages.adb";
    };
    packages =
      let
        p = ./packages.nix;
