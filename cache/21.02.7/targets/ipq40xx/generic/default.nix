# 21.02.7 ipq40xx/generic
{
  baseUrl = "https://downloads.openwrt.org/releases/21.02.7/targets/ipq40xx/generic/";
  sha256sums = {
    hash = "sha256-5SzZGDQV2r5EL4HnDL4uC+Nl87jxBD1DSySaINblFw0=";
    name = "ipq40xx_generic-sha256sums";
    url = "https://downloads.openwrt.org/releases/21.02.7/targets/ipq40xx/generic/sha256sums";
  };
  imagebuilder = {
    sha256 = "04097acda5c9d53093bf5e0cccb256d0dbfad10058fbfe6d3c0ff5224d59bfd7";
    filename = "openwrt-imagebuilder-21.02.7-ipq40xx-generic.Linux-x86_64.tar.xz";
  };
  profiles.sourceInfo = {
    hash = "sha256-QFldgBr7iVd4uOju+jYHSFHWZ/tfDhKoqeABSGdn190=";
    name = "ipq40xx_generic-profiles.json";
    url = "https://downloads.openwrt.org/releases/21.02.7/targets/ipq40xx/generic/profiles.json";
  };
  profiles.extract = {
  ...
  corePackages = {
    baseUrl = "https://downloads.openwrt.org/releases/21.02.7/targets/ipq40xx/generic/packages/";
    sourceInfo = {
      hash = "sha256-19kJ/WHgDWp0dgMCIrVeGbQb4h1v05JZbiHxeovAUSc=";
      name = "ipq40xx_generic-Packages";
      url = "https://downloads.openwrt.org/releases/21.02.7/targets/ipq40xx/generic/packages/Packages";
    };
    packages =
      let
        p = ./packages.nix;
