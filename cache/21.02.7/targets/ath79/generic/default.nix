# 21.02.7 ath79/generic
{
  baseUrl = "https://downloads.openwrt.org/releases/21.02.7/targets/ath79/generic/";
  sha256sums = {
    hash = "sha256-ntapfjj13R/Uhl94WWnjoFBAgddkOUyLejUgJwcMN5g=";
    name = "ath79_generic-sha256sums";
    url = "https://downloads.openwrt.org/releases/21.02.7/targets/ath79/generic/sha256sums";
  };
  imagebuilder = {
    sha256 = "eaa337f5ca05e7dbc55993d7ac8ce9503991b442a50ba9bd58f6484b0a0cd41a";
    filename = "openwrt-imagebuilder-21.02.7-ath79-generic.Linux-x86_64.tar.xz";
  };
  profiles.sourceInfo = {
    hash = "sha256-ui0we1WziJ2d9fP9aPs6cx28wm78GwmxZbX97Xlptb4=";
    name = "ath79_generic-profiles.json";
    url = "https://downloads.openwrt.org/releases/21.02.7/targets/ath79/generic/profiles.json";
  };
  profiles.extract = {
  ...
  corePackages = {
    baseUrl = "https://downloads.openwrt.org/releases/21.02.7/targets/ath79/generic/packages/";
    sourceInfo = {
      hash = "sha256-Mi97s+YLO1rMs4c4dHw0hSjqEZCvZ/XswFOx5QqrWeQ=";
      name = "ath79_generic-Packages";
      url = "https://downloads.openwrt.org/releases/21.02.7/targets/ath79/generic/packages/Packages";
    };
    packages =
      let
        p = ./packages.nix;
