# 25.12.0 ath79/generic
{
  baseUrl = "https://downloads.openwrt.org/releases/25.12.0/targets/ath79/generic/";
  sha256sums = {
    hash = "sha256-0YWqtZCqzz0fYgxBCFhfAO+3KtfcwkA5J1YUhBs/82g=";
    name = "ath79_generic-sha256sums";
    url = "https://downloads.openwrt.org/releases/25.12.0/targets/ath79/generic/sha256sums";
  };
  imagebuilder = {
  ...
  profiles.sourceInfo = {
    hash = "sha256-42HRbCRCftoMiHt6PXiwKLDrw2jMzxkX9mmQCIFnqmY=";
    name = "ath79_generic-profiles.json";
    url = "https://downloads.openwrt.org/releases/25.12.0/targets/ath79/generic/profiles.json";
  };
  profiles.extract = {
    ...
    kmods_target = "6.12.71-1-c9318ac0cd981a67d503c47ccc54781a";
    profiles = {
      "8dev_carambola2" = {
  ...
  kmods."6.12.71-1-c9318ac0cd981a67d503c47ccc54781a" = {
    baseUrl = "https://downloads.openwrt.org/releases/25.12.0/targets/ath79/generic/kmods/6.12.71-1-c9318ac0cd981a67d503c47ccc54781a/";
    sourceInfo = {
      hash = "sha256-oJD3m1n5P7974KGlxdfOk0f+7F5P99RzS+im2kgnjtU=";
      name = "kmods-ath79_generic-packages.adb";
      url = "https://downloads.openwrt.org/releases/25.12.0/targets/ath79/generic/kmods/6.12.71-1-c9318ac0cd981a67d503c47ccc54781a/packages.adb";
    };
    packages =
      let
        p = ./kmods.nix;
  ...
  corePackages = {
    baseUrl = "https://downloads.openwrt.org/releases/25.12.0/targets/ath79/generic/packages/";
    sourceInfo = {
      hash = "sha256-3EIa9QxnBGRu12/mU6nvnQL8r0+IfzVPNkF88pkZlK8=";
      name = "ath79_generic-packages.adb";
      url = "https://downloads.openwrt.org/releases/25.12.0/targets/ath79/generic/packages/packages.adb";
    };
    packages =
      let
        p = ./packages.nix;
