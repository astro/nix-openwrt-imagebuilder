# 25.12.0 ramips/mt7621
{
  baseUrl = "https://downloads.openwrt.org/releases/25.12.0/targets/ramips/mt7621/";
  sha256sums = {
    hash = "sha256-iiITmvpexjJESRmzoDZ+Gtwh/lnaG3tvi1k4yQi6Yqk=";
    name = "ramips_mt7621-sha256sums";
    url = "https://downloads.openwrt.org/releases/25.12.0/targets/ramips/mt7621/sha256sums";
  };
  imagebuilder = {
    sha256 = "cc4cc7642ea7c26c8d57695466b86ec7c9c837585aa89649f8da700a6fdb1460";
    filename = "openwrt-imagebuilder-25.12.0-ramips-mt7621.Linux-x86_64.tar.zst";
  };
  profiles.sourceInfo = {
    hash = "sha256-t9VjPYofzF98WbDom+tVUK6/LGgi0u6amKwW/kcsv5U=";
    name = "ramips_mt7621-profiles.json";
    url = "https://downloads.openwrt.org/releases/25.12.0/targets/ramips/mt7621/profiles.json";
  };
  profiles.extract = {
    arch_packages = "mipsel_24kc";
    linux_kernel = {
      release = "1";
      vermagic = "364f8debbcd4cddc1f038dea515bf8a5";
      version = "6.12.71";
    };
    default_packages = [
      "apk-mbedtls"
    ...
    kmods_target = "6.12.71-1-364f8debbcd4cddc1f038dea515bf8a5";
    profiles = {
      adslr_g7 = {
        device_packages = [
  ...
  kmods."6.12.71-1-364f8debbcd4cddc1f038dea515bf8a5" = {
    baseUrl = "https://downloads.openwrt.org/releases/25.12.0/targets/ramips/mt7621/kmods/6.12.71-1-364f8debbcd4cddc1f038dea515bf8a5/";
    sourceInfo = {
      hash = "sha256-1SLrUdsXR6qGWBbySmzAkTVeEwtBTWkpe0xzGIKmAl8=";
      name = "kmods-ramips_mt7621-packages.adb";
      url = "https://downloads.openwrt.org/releases/25.12.0/targets/ramips/mt7621/kmods/6.12.71-1-364f8debbcd4cddc1f038dea515bf8a5/packages.adb";
    };
    packages =
      let
        p = ./kmods.nix;
  ...
  corePackages = {
    baseUrl = "https://downloads.openwrt.org/releases/25.12.0/targets/ramips/mt7621/packages/";
    sourceInfo = {
      hash = "sha256-1w92lGIHljCqR9gi95TjZXPTXMIwbZV+yqP8GCIuizg=";
      name = "ramips_mt7621-packages.adb";
      url = "https://downloads.openwrt.org/releases/25.12.0/targets/ramips/mt7621/packages/packages.adb";
    };
    packages =
      let
        p = ./packages.nix;
