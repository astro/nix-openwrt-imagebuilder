{
  ...
  base-files = {
    ...
    sha256 = "97d3e43a6e4f17a07ef2fe8dde0aa6d9ba81400b5f4ba6e9c02c99033af68714";
  };
  bcm4908img = {
    version = "3";
  ...
  kernel = {
    version = "6.12.71~979d0774cde439adfa7583dbecfa6499-r1";
    filename = "kernel-6.12.71~979d0774cde439adfa7583dbecfa6499-r1.apk";
    depends = [ "libc" ];
    provides = [ "kernel-any" ];
    sha256 = "7fbcd4b401979866ad732febad2755a7eff39e1001e8e1ebe01eab3f35303f14";
  };
  libatomic1 = {
    version = "14.3.0-r5";
