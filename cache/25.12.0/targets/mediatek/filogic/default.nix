# 25.12.0 mediatek/filogic
{
  baseUrl = "https://downloads.openwrt.org/releases/25.12.0/targets/mediatek/filogic/";
  sha256sums = {
    hash = "sha256-S4CWo2vMaUTNZo876OdGW7Fx9rLTiMKSgrtZjmATeC4=";
    name = "mediatek_filogic-sha256sums";
    url = "https://downloads.openwrt.org/releases/25.12.0/targets/mediatek/filogic/sha256sums";
  };
  imagebuilder = {
  ...
  profiles.sourceInfo = {
    hash = "sha256-8Ey8ko/XHuq00Qqk/PJme715PM0bu29mcqvHctzs+4o=";
    name = "mediatek_filogic-profiles.json";
    url = "https://downloads.openwrt.org/releases/25.12.0/targets/mediatek/filogic/profiles.json";
  };
  profiles.extract = {
    ...
    kmods_target = "6.12.71-1-60d938adcb727697d3015e4285d4c290";
    profiles = {
      abt_asr3000 = {
        device_packages = [
          "kmod-mt7915e"
  ...
  kmods."6.12.71-1-60d938adcb727697d3015e4285d4c290" = {
    baseUrl = "https://downloads.openwrt.org/releases/25.12.0/targets/mediatek/filogic/kmods/6.12.71-1-60d938adcb727697d3015e4285d4c290/";
    sourceInfo = {
      hash = "sha256-oeMLi+52W7bnmwDVXLyoSNSfq+2CA8pe6wVg9bVY2Vk=";
      name = "kmods-mediatek_filogic-packages.adb";
      url = "https://downloads.openwrt.org/releases/25.12.0/targets/mediatek/filogic/kmods/6.12.71-1-60d938adcb727697d3015e4285d4c290/packages.adb";
    };
    packages =
      let
        p = ./kmods.nix;
  ...
  corePackages = {
    baseUrl = "https://downloads.openwrt.org/releases/25.12.0/targets/mediatek/filogic/packages/";
    sourceInfo = {
      hash = "sha256-/r3n338uGtwy9Y0l3kEgUeC6kKahhaJyeyjli6SAljA=";
      name = "mediatek_filogic-packages.adb";
      url = "https://downloads.openwrt.org/releases/25.12.0/targets/mediatek/filogic/packages/packages.adb";
    };
    packages =
      let
        p = ./packages.nix;
