# 23.05.6 ath79/generic
{
  baseUrl = "https://downloads.openwrt.org/releases/23.05.6/targets/ath79/generic/";
  sha256sums = {
    hash = "sha256-d7WPdGyHEKtTmUERJsnJsZdARTFaH/AbIkmV6XJ8SQA=";
    name = "ath79_generic-sha256sums";
    url = "https://downloads.openwrt.org/releases/23.05.6/targets/ath79/generic/sha256sums";
  };
  imagebuilder = {
    sha256 = "f3e970cddd161377d3420371f32e2593b0f21b35bb524a753f41b0a2bd381600";
    filename = "openwrt-imagebuilder-23.05.6-ath79-generic.Linux-x86_64.tar.xz";
  };
  profiles.sourceInfo = {
    hash = "sha256-J9VQngwKWObYWqzjBn2Le4u934MCshMPJAeixvt4YeQ=";
    name = "ath79_generic-profiles.json";
    url = "https://downloads.openwrt.org/releases/23.05.6/targets/ath79/generic/profiles.json";
  };
  profiles.extract = {
    arch_packages = "mips_24kc";
    linux_kernel = {
      release = "1";
      vermagic = "08472e4058c44b683bc720c4c463d58c";
      version = "5.15.189";
    };
    default_packages = [
      "base-files"
    ...
    kmods_target = "5.15.189-1-08472e4058c44b683bc720c4c463d58c";
    profiles = {
      "8dev_carambola2" = {
  ...
  corePackages = {
    baseUrl = "https://downloads.openwrt.org/releases/23.05.6/targets/ath79/generic/packages/";
    sourceInfo = {
      hash = "sha256-woOP9ruhkeiDgkchUCSf38PnIMFYwMiDHeCn7liVOEo=";
      name = "ath79_generic-Packages";
      url = "https://downloads.openwrt.org/releases/23.05.6/targets/ath79/generic/packages/Packages";
    };
    packages =
      let
        p = ./packages.nix;
