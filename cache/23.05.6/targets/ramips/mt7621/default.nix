# 23.05.6 ramips/mt7621
{
  baseUrl = "https://downloads.openwrt.org/releases/23.05.6/targets/ramips/mt7621/";
  sha256sums = {
    hash = "sha256-sbaZauU+l9ZLikBInQKO85Uc/b0R/qwiSjQoYIEbZbk=";
    name = "ramips_mt7621-sha256sums";
    url = "https://downloads.openwrt.org/releases/23.05.6/targets/ramips/mt7621/sha256sums";
  };
  imagebuilder = {
    sha256 = "55059eada5ac9705ce6fd079d3066fb9488a19d2828c002e802e7cf72b2dd74c";
    filename = "openwrt-imagebuilder-23.05.6-ramips-mt7621.Linux-x86_64.tar.xz";
  };
  profiles.sourceInfo = {
    hash = "sha256-tSWgTEAmR+YsXxvt1hRzXKyaZf5+N+Qira8zkIpzpgI=";
    name = "ramips_mt7621-profiles.json";
    url = "https://downloads.openwrt.org/releases/23.05.6/targets/ramips/mt7621/profiles.json";
  };
  profiles.extract = {
    ...
    kmods_target = "5.15.189-1-4f2d344a1dace96707d0f22ddf55d176";
    profiles = {
      adslr_g7 = {
        device_packages = [
  ...
  corePackages = {
    baseUrl = "https://downloads.openwrt.org/releases/23.05.6/targets/ramips/mt7621/packages/";
    sourceInfo = {
      hash = "sha256-fw/ACzBtdL4LujmbkkI+4dqmQxx2cWLWOr3aggzzSRo=";
      name = "ramips_mt7621-Packages";
      url = "https://downloads.openwrt.org/releases/23.05.6/targets/ramips/mt7621/packages/Packages";
    };
    packages =
      let
        p = ./packages.nix;
