# 24.10.5 ramips/mt7621
{
  baseUrl = "https://downloads.openwrt.org/releases/24.10.5/targets/ramips/mt7621/";
  sha256sums = {
    hash = "sha256-Ci+yG/VZopCON6W+SdHREklPFh1kzHMkhkafbRWcXNk=";
    name = "ramips_mt7621-sha256sums";
    url = "https://downloads.openwrt.org/releases/24.10.5/targets/ramips/mt7621/sha256sums";
  };
  imagebuilder = {
    sha256 = "f3bf1ed05813a873b01d8645dc002a10558673fad57d3a75e839bac62358c72c";
    filename = "openwrt-imagebuilder-24.10.5-ramips-mt7621.Linux-x86_64.tar.zst";
  };
  profiles.sourceInfo = {
    hash = "sha256-WKOGbB34jJoVtd/lJbpwV733hXyYF7ZD7070KeTuX1g=";
    name = "ramips_mt7621-profiles.json";
    url = "https://downloads.openwrt.org/releases/24.10.5/targets/ramips/mt7621/profiles.json";
  };
  profiles.extract = {
    arch_packages = "mipsel_24kc";
    linux_kernel = {
      release = "1";
      vermagic = "6c0cbfffdf5543d41b1de30e3a9c928d";
      version = "6.6.119";
    };
    default_packages = [
      "base-files"
    ...
    kmods_target = "6.6.119-1-6c0cbfffdf5543d41b1de30e3a9c928d";
    profiles = {
      adslr_g7 = {
        device_packages = [
  ...
  kmods."6.6.119-1-6c0cbfffdf5543d41b1de30e3a9c928d" = {
    baseUrl = "https://downloads.openwrt.org/releases/24.10.5/targets/ramips/mt7621/kmods/6.6.119-1-6c0cbfffdf5543d41b1de30e3a9c928d/";
    sourceInfo = {
      hash = "sha256-5WBT/+8CwYbHMd/MsPz4GdFVABYr7ypOyWXynWi4+C4=";
      name = "kmods-ramips_mt7621-Packages";
      url = "https://downloads.openwrt.org/releases/24.10.5/targets/ramips/mt7621/kmods/6.6.119-1-6c0cbfffdf5543d41b1de30e3a9c928d/Packages";
    };
    packages =
      let
        p = ./kmods.nix;
  ...
  corePackages = {
    baseUrl = "https://downloads.openwrt.org/releases/24.10.5/targets/ramips/mt7621/packages/";
    sourceInfo = {
      hash = "sha256-rojTHJB7k/toAhM+YnFcBhXGhQB8By4x8FN3hJSJ6sI=";
      name = "ramips_mt7621-Packages";
      url = "https://downloads.openwrt.org/releases/24.10.5/targets/ramips/mt7621/packages/Packages";
    };
    packages =
      let
        p = ./packages.nix;
