# 24.10.5 ath79/generic
{
  baseUrl = "https://downloads.openwrt.org/releases/24.10.5/targets/ath79/generic/";
  sha256sums = {
    hash = "sha256-Bd2BQdpuWdaiNa+tUegyddGwiDFUzDOz3cjZSRhXrgc=";
    name = "ath79_generic-sha256sums";
    url = "https://downloads.openwrt.org/releases/24.10.5/targets/ath79/generic/sha256sums";
  };
  imagebuilder = {
    sha256 = "d4b3d8b441b665fea4177868a3c6c79bf6d0e744d008b8361d4030e52e553328";
    filename = "openwrt-imagebuilder-24.10.5-ath79-generic.Linux-x86_64.tar.zst";
  };
  profiles.sourceInfo = {
    hash = "sha256-9rJVfwbCOyDZufw7tX+NbuxXp1/JlS3jbbhBI0begbU=";
    name = "ath79_generic-profiles.json";
    url = "https://downloads.openwrt.org/releases/24.10.5/targets/ath79/generic/profiles.json";
  };
  profiles.extract = {
    arch_packages = "mips_24kc";
    linux_kernel = {
      release = "1";
      vermagic = "35ef4dd36891d37023436baa842fa311";
      version = "6.6.119";
    };
    default_packages = [
      "base-files"
    ...
    kmods_target = "6.6.119-1-35ef4dd36891d37023436baa842fa311";
    profiles = {
      "8dev_carambola2" = {
  ...
  kmods."6.6.119-1-35ef4dd36891d37023436baa842fa311" = {
    baseUrl = "https://downloads.openwrt.org/releases/24.10.5/targets/ath79/generic/kmods/6.6.119-1-35ef4dd36891d37023436baa842fa311/";
    sourceInfo = {
      hash = "sha256-C0rAoYsbfS4RXrSHAPhejx1WTJ8tkLFL4oxflq7+6l8=";
      name = "kmods-ath79_generic-Packages";
      url = "https://downloads.openwrt.org/releases/24.10.5/targets/ath79/generic/kmods/6.6.119-1-35ef4dd36891d37023436baa842fa311/Packages";
    };
    packages =
      let
        p = ./kmods.nix;
  ...
  corePackages = {
    baseUrl = "https://downloads.openwrt.org/releases/24.10.5/targets/ath79/generic/packages/";
    sourceInfo = {
      hash = "sha256-ONwluGSacK1Mz+vw3eiz0v0oiSzmHAy5S/LZWwxMpyM=";
      name = "ath79_generic-Packages";
      url = "https://downloads.openwrt.org/releases/24.10.5/targets/ath79/generic/packages/Packages";
    };
    packages =
      let
        p = ./packages.nix;
