...
{
  sha256sums = {
    hash = "sha256-LxcN+M5Wdy+Y1A3WktZlIA6LcSpkg7IKEhhPxaeaPoM=";
  ...
  feeds."packages" = {
    ...
    sourceInfo = {
      hash = "sha256-L2Lby8s+aVnbaGKDj/HxTP8YHrShyL4cyfi/V4GwmL8=";
  ...
  feeds."telephony" = {
    ...
    sourceInfo = {
      hash = "sha256-jI4ZTqZu/nBrGQ92Ar+P3c5GeCNy7q6+l2pAgxtmags=";
