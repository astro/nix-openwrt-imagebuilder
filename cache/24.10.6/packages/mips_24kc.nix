...
{
  sha256sums = {
    hash = "sha256-MrEGUJaEmGUZMkek2w2s+eXPFptqTjzbl+A9CNomltM=";
  ...
  feeds."packages" = {
    ...
    sourceInfo = {
      hash = "sha256-EL9spGNDsP0wJ+rlIql6pLEYb3Pd8Gly0iyzCR2UTSw=";
  ...
  feeds."telephony" = {
    ...
    sourceInfo = {
      hash = "sha256-matxaabUw90Ibzry8jeA8JoNIPQ1EECfphgiWjTAko8=";
