# 25.12.1 qualcommax/ipq807x
{
  baseUrl = "https://downloads.openwrt.org/releases/25.12.1/targets/qualcommax/ipq807x/";
  sha256sums = {
    hash = "sha256-nZnJ7oThrOthg0i8K4qey459LcVvDpMMkUIjpgFRi+I=";
    name = "qualcommax_ipq807x-sha256sums";
    url = "https://downloads.openwrt.org/releases/25.12.1/targets/qualcommax/ipq807x/sha256sums";
  };
  imagebuilder = {
    sha256 = "8a9628dcea17b3d68290bbd6e9d54c587bdefd10bf29ea5df4105b65060ba03a";
    filename = "openwrt-imagebuilder-25.12.1-qualcommax-ipq807x.Linux-x86_64.tar.zst";
  };
  profiles.sourceInfo = {
    hash = "sha256-i9hkZhe/a6p9mib+dSG100P8RELEoD/9ooA5mG1cNj8=";
    name = "qualcommax_ipq807x-profiles.json";
    url = "https://downloads.openwrt.org/releases/25.12.1/targets/qualcommax/ipq807x/profiles.json";
  };
  profiles.extract = {
  ...
  kmods."6.12.74-1-9aa78420ad5a02b13026a1936e68b01c" = {
    baseUrl = "https://downloads.openwrt.org/releases/25.12.1/targets/qualcommax/ipq807x/kmods/6.12.74-1-9aa78420ad5a02b13026a1936e68b01c/";
    sourceInfo = {
      hash = "sha256-kBmdNF5HB6o/WCMH8k798GNmTepA2fXyACVbnWM2kqk=";
      name = "kmods-qualcommax_ipq807x-packages.adb";
      url = "https://downloads.openwrt.org/releases/25.12.1/targets/qualcommax/ipq807x/kmods/6.12.74-1-9aa78420ad5a02b13026a1936e68b01c/packages.adb";
    };
    packages =
      let
        p = ./kmods.nix;
  ...
  corePackages = {
    baseUrl = "https://downloads.openwrt.org/releases/25.12.1/targets/qualcommax/ipq807x/packages/";
    sourceInfo = {
      hash = "sha256-afwAHdPKE0PyVTqmxOKB/RelNNoG3CRZGWH4nvVZi6Q=";
      name = "qualcommax_ipq807x-packages.adb";
      url = "https://downloads.openwrt.org/releases/25.12.1/targets/qualcommax/ipq807x/packages/packages.adb";
    };
    packages =
      let
        p = ./packages.nix;
