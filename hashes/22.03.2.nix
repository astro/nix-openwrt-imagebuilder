{
  ...
  packages."arm_cortex-a15_neon-vfpv4"."packages".sha256 = "1m13k2gsry9bf2czgh7kcy69n2wcclk1ynkjhawjxxqvfqimrj7n";
  packages."arm_cortex-a15_neon-vfpv4"."routing".sha256 = "0bg3gk4yphg57rrklf2cpi5lgyw1azbcdlxw7ib5dwnacgq8sn5y";
  packages."arm_cortex-a15_neon-vfpv4"."telephony".sha256 = "0gmas0p830x4kns4zgvnvpywi8hmz62zm6xqvrwxx6037rk3kvbp";
